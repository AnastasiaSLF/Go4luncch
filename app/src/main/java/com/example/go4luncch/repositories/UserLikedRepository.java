...
import com.example.go4luncch.utils.LikedRestaurantHelper;
...
public class UserLikedRepository {
    private MutableLiveData<List<RestaurantLiked>> listOfUsersLikingARestaurant = new MutableLiveData<>();

    LikedRestaurantHelper helperFirestoreLikedRestaurant = new LikedRestaurantHelper();
